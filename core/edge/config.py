...
def load_edge_settings(path: str | Path = "config/settings.yaml") -> EdgeSettings:
    ...
    return EdgeSettings(
        ...
        full_sync_interval_seconds=max(3600, int(values.get("full_sync_interval_seconds", defaults.full_sync_interval_seconds))),
        ...
        delivery_poll_interval_seconds=min(60, max(1, int(values.get("delivery_poll_interval_seconds", defaults.delivery_poll_interval_seconds)))),
